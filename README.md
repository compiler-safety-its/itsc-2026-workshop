...
- **[2026-07-31 update:** **Dániel Szűcs's speaker card is COMPLETE and live** — 229-word abstract, 106-word bio, headshot (`assets/daniel-szucs.jpg`; the file he sent was named `.png` but is JPEG data), delivered 2026-07-31, title unchanged. All three speaker cards now carry abstract + bio + headshot. **The under-construction banner deliberately STAYS UP** (KW's call): the lift condition below includes **logos**, and HighTec has not supplied an org logo — the Solid Sands and 2getthere cards both carry one, so the HighTec card is not yet at parity. Lift the banner once that logo lands (ask Mario; Dániel on vacation to 2026-08-09). Nothing else is outstanding from any speaker until the closing-panel feedback round (reply target 2026-08-24). LinkedIn announcement window: 2026-08-11–18.]
